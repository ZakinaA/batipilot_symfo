...
final class Version20260122090915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chantier ADD surface_plancher DOUBLE PRECISION DEFAULT NULL, ADD surface_habitable DOUBLE PRECISION DEFAULT NULL, DROP surface_plancher, DROP surface_habitable, DROP chantier_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chantier ADD surface_plancher DOUBLE PRECISION DEFAULT NULL, ADD surface_habitable DOUBLE PRECISION DEFAULT NULL, ADD chantier_id INT DEFAULT NULL, DROP surface_plancher, DROP surface_habitable');
